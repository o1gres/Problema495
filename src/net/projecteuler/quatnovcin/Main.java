...
public class Main {
	...
	public static void main(String[] args) {
		...
		BigInteger t2 = new BigInteger("10000");
		BigInteger result = Fattoriale.factorial(t2);
		String fattoriale = result.toString();
		
		Operation operation = new Operation();
		operation.calc(144, 4);
		
		System.out.println(fattoriale.length());
	}
